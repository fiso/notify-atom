'use babel';
import NotifyAtomView from './notify-atom-view';
...
export default {
  ...
  activate (state) {
    this.notifyAtomView = new NotifyAtomView(state.notifyAtomViewState);
  ...
  deactivate () {
    ...
    this.notifyAtomView.destroy();
  },

  serialize () {
    return {
      notifyAtomViewState: this.notifyAtomView.serialize()
    };
  },
};
